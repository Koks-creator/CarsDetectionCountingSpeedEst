...
class ObjectDetection:
    weights_path: str = "yolov4-tiny.weights" #https://github.com/AlexeyAB/darknet/releases
    cfg_path: str = "yolov4-tiny.cfg" #https://github.com/AlexeyAB/darknet/tree/master/cfg
